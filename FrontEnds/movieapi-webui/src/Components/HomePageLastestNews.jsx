export default function HomePageLastestNews() {
    return (
        <>
                                        ...
                                        <div className="row">
                                            <div className="blog-item-style-1">
                                                ...
                                                <div className="blog-it-infor">
                                                    <h3>
                                                        <a href="#">
                                                            Brie Larson to play first female white house candidate
                                                            Victoria Woodull in Amazon film
                                                        </a>
                                                    </h3>
                                ...
                                <div className="more-items">
                                    <div className="left">
                                        ...
                                        <div className="more-it">
                                            <h6>
                                                <a href="#">
                                                    French cannibal horror “Raw” inspires L.A. theater to hand
                                                    out “Barf Bags”
                                                </a>
                                            </h6>
                                            <span className="time">13 hours ago</span>
